...
async function registrar() {
    try {
        ...
        const dadosParaEnviar = {
            ra: ra,
            senha: senha,
            action: isLogin ? 'login' : 'cadastro' // ← ADICIONAR ACTION EXPLÍCITA
        };
        ...
        if (result.success) {
            // ✅ LIMPAR SESSÃO ANTIGA E SALVAR NOVA (SEM SESSION ID)
            limparSessaoAntiga();
            salvarNovaSessao(result.usuario); // ← CORRIGIDO: sem sessionId
...
// ✅ 8. FUNÇÃO fazerLogout - CORRIGIDA (sem API call)
...
// ✅ 9. FUNÇÃO verificarSessaoAtiva - CORRIGIDA (sem sessionId)
...
// ✅ 10. FUNÇÃO getUsuarioId - Nova função útil
...
// ✅ INICIALIZAÇÃO - DOMContentLoaded CORRIGIDA
